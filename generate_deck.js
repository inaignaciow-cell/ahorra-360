  ...
  },
  {
    ...
    content: `
      ...
      <div class="card" style="border-left:8px solid #F59E0B">
        ...
        <p>Modelo White-Label ("Powered by Ahorra 360") para banca legacy (Ing Santander, etc) para fidelizar retenciones de nómina. Internacionalización a Portugal y México. Venta legal de datasets agregados/anonimizados hiper-locales de inflación real de la familia a fondos de inversión macro.</p>
      </div>
    `
  },
  {
...
pages.forEach((page, i) => {
  if (page.type === 'cover') {
    htmlStr += \`<div class="pdf-page cover">\${page.content}</div>\`;
  } else {
    htmlStr += \`
      <div class="pdf-page">
        <div class="header">
...
fs.writeFileSync('C:/Users/ignac/Ahorra 360/Ahorra360_Pitch_Deck_Inversor.html', htmlStr);
console.log("¡Pitch deck generado exitosamente en html/pdf!");
